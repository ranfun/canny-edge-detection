        ...
        short int **smoothedim)
{
   ...
   ****************************************************************************/
   int x_thread = 4;					//Edited by Jiang Wan for multi-thread
   omp_set_dynamic(0);					//Edited by Jiang Wan for multi-thread
   omp_set_num_threads(x_thread);			//Edited by Jiang Wan for multi-thread
   ...
   ****************************************************************************/
   int y_thread = 4;					//Edited by Jiang Wan for multi-thread
   omp_set_dynamic(0);					//Edited by Jiang Wan for multi-thread
   omp_set_num_threads(y_thread);			//Edited by Jiang Wan for multi-thread
   #pragma omp1 parallel private(c, cc, dot, sum)
   {
